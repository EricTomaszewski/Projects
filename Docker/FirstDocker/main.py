# https://github.com/patrickloeber/python-fun/blob/master/moviepicker/main.py
# https://www.youtube.com/watch?v=bi0cKgmRuiA&t=162s

import random
import requests
from bs4 import BeautifulSoup

# crawl IMDB Top 250 and randomly select a movie >>> does NOT work because of IMDB 403 error => FORBIDDEN
...
def main():
    ...
    while(True):
        ...
        print("Random number between 0 & 250: ", idx)
